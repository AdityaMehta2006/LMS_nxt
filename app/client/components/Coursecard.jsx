  ...
  return (
    <div
      ...
      className={cn(
        ...
        "border border-gray-200 border-l-4 border-l-emerald-500", // Color coding for "Active/Admin"
    ...
    >
      ...
      <div className="flex justify-between items-start mb-2">
        <div className="flex flex-col">
          <span className="text-[11px] font-bold text-emerald-600 bg-emerald-50 px-2 py-0.5 rounded-full w-max mb-2">
            {courseId}
          </span>
          <h2 className="text-lg font-bold text-gray-800 group-hover:text-emerald-700 transition-colors line-clamp-2 leading-snug">
            {Course}
          </h2>
        </div>

        <button
          className="text-gray-400 hover:text-red-500 hover:bg-red-50 p-2 rounded-full transition-all z-10" // z-10 to stay above card click
          onClick={(e) => {
            e.stopPropagation();
